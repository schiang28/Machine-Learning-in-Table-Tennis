...
Table~\ref{table:nonlin} shows the final  set of features. Newly derived features are indicated with *. More detailed explanations can be found in subsections \ref{sp} to \ref{balance}.
...
In this paper we define a long rally  as a rally of at least five shots \denes{ I'm confused again about the meaning of a long vs short rally}. c.f.: 
The proportion of points won on a long rally by a player, determined by the location of the last bounce in a rally. E.g. \figref{svlr} shows that one player won 47 points on a long rally, while the other won 45 \denes{how do we get percentage?}.
...
The ranking of the player \denes{who establishes the ranking? ITTF?}
