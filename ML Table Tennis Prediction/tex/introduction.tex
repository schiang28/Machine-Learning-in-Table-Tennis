...
Machine learning methods have been frequently used in other sports, such as tennis \cite{cornman2017machine} and football \cite{hucaljuk2011predicting}. Proposed applications involve improved training efficiency \denes{consider no citation, and repeat ref later in the text} as well as result prediction. Specifically, result prediction is of special interest to sport fans, but little has been done in table tennis prediction.
