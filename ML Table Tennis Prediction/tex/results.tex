...
$$
where $tp$ and $tn$ are true positives and true negatives, and $fp$ and $fn$ are false positives and false negatives respectively \cite{vanwinckelen2012estimating}. Confusion matrices for each classification model can be visualised in Figure \ref{confusionmatrices}.
